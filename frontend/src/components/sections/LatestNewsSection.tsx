...
export function LatestNewsSection({ news, id = "actualites" }: LatestNewsSectionProps) {
  return (
    <section id={id} className="rounded-3xl border border-slate-100 bg-white px-6 py-16 shadow-sm sm:px-10">
      <div className="mb-8 flex flex-wrap items-end justify-between gap-4">
        <SectionHeading eyebrow="Actualité" title="Toute la vie du campus" description="Événements, projets étudiants et annonces importantes." />
